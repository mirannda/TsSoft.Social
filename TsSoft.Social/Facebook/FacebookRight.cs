namespace TsSoft.Social.Facebook
{
    ...
    public enum FacebookRight
    {
        ...
        /// first screen of the Enhanced Auth Dialog and cannot be revoked as 
        /// part of the authentication flow.
        /// However, a user can later revoke this permission in their Account Settings.
        /// If you want to be notified if this happens, 
        ...
        /// <summary>
        /// Allows you to retrieve the actions published by all applications 
        /// using the built-in music.listens action.
        /// </summary>
        ...
        /// <summary>
        /// Allows you to retrieve the actions published by all applications 
        /// using the built-in news.reads action.
        /// </summary>
        ...
        /// <summary>
        /// Allows you to retrieve the actions published by all applications 
        /// using the built-in video.watches action.
        /// </summary>
        [Description("user_actions.video")]
        UserActionVideo,

        /// <summary>
        /// Enables your application to retrieve access_tokens for Pages and 
        /// Applications that the user administrates.
        /// The access tokens can be queried by calling /<user_id>/accounts 
        /// via the Graph API.
        /// See here for generating long-lived Page access tokens 
        /// that do not expire after 60 days.
        /// </summary>
        ...
        /// Please read the Platform Policies to ensure you understand 
        /// how to properly use this permission.
        /// Note, you do not need to request the publish_stream permission 
        /// in order to use the Feed Dialog, the Requests Dialog or the Send Dialog.
        /// </summary>
        ...
        /// this extended permission grants access to the lists of 
        /// friends a user has created, and should only be requested 
        ...
        /// <summary>
        /// Provides read access to the Insights data for pages, 
        /// applications, and domains the user owns.
        /// </summary>
        ...
        /// in the user's News Feed and enables 
        /// your application to perform searches 
        ...
        /// <summary>
        /// Provides applications that integrate with 
        /// Facebook Chat the ability to log in users.
        /// </summary>
        [Description("xmpp_login")]
        XmppLogin,

        /// <summary>
        /// Provides the ability to manage ads and call 
        /// the Facebook Ads API on behalf of a user.
        /// </summary>
        [Description("ads_management")]
        AdsManagement,

        /// <summary>
        /// Enables your application to create and modify 
        ...
        /// <summary>
        /// Enables your app to create and edit the user's 
        /// friend lists.
        /// </summary>
        ...
        /// Intended usage: This permission should be used to let users 
        /// read and act on their notifications; it should not be used 
        /// to for the purposes of modeling user behavior or data mining. 
